...
let CarWashService = class CarWashService {
    ...
    async findOne(id) {
        ...
        if (!carWash) {
            throw new common_1.NotFoundException(`CarWash with ID ${id} not found`);
        }
        return carWash;
    }
...
exports.CarWashService = CarWashService;
exports.CarWashService = CarWashService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(car_wash_entity_1.CarWash)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], CarWashService);
//# sourceMappingURL=car-wash.service.js.map